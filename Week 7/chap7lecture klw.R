...
# summary - we do a good job of explaining the means in the data,
# but a poor job explaining continuous relationships
...
#Plot posterior predicted distribution vs observed
